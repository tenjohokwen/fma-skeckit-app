export default {
  ...
  files: {
    ...
    upload: {
      ...
      or: "or",
      uploading: "Uploading...",
      uploadingProgress: "Please wait while your files are being uploaded...",
      uploadButton: "Upload {count} File(s)",
      success: "File uploaded successfully",
      multipleSuccess: "{count} files uploaded successfully",
      partialSuccess: "{success} files uploaded, {failed} failed",
      allFailed: "All {count} files failed to upload",
      filesSelected: "{count} file(s) selected",
      totalSize: "Total size",
      maxSize: "Maximum file size: 50MB per file",
      fileName: "File Name",
      fileSize: "File Size",
      uploadedAt: "Uploaded At",
      fileId: "File ID",
      error: {
        size: "File {name} exceeds maximum size of 50MB",
        filename: "File {name} contains invalid characters",
        duplicate: "File {name} is already selected",
