export default {
  common: {
    ...
    viewOnlyTooltip: "Vous avez un accès en lecture seule. Contactez un administrateur pour créer, modifier ou supprimer du contenu."
  },
  auth: {
    signup: {
  ...
  files: {
    ...
    upload: {
      ...
      uploadingProgress: "Veuillez patienter pendant le téléchargement de vos fichiers...",
      uploadButton: "Télécharger {count} Fichier(s)",
      success: "Fichier téléchargé avec succès",
      multipleSuccess: "{count} fichiers téléchargés avec succès",
      partialSuccess: "{success} fichiers téléchargés, {failed} échoués",
      allFailed: "Tous les {count} fichiers ont échoué",
      filesSelected: "{count} fichier(s) sélectionné(s)",
      totalSize: "Taille totale",
      maxSize: "Taille maximale: 50 Mo par fichier",
      fileName: "Nom du Fichier",
      fileSize: "Taille du Fichier",
      uploadedAt: "Téléchargé le",
      fileId: "ID du Fichier",
      error: {
        size: "Le fichier {name} dépasse la taille maximale de 50 Mo",
        filename: "Le fichier {name} contient des caractères invalides",
        duplicate: "Le fichier {name} est déjà sélectionné",
